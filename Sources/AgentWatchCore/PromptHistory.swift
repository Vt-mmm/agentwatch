...
public enum PromptHistory {
    ...
    public static func loadPrompts(in range: Range<Date>) -> [PromptRecord] {
    ...
    private static func loadCodexPrompts(in range: Range<Date>) -> [PromptRecord] {
    ...
    private static func loadPiAgentPrompts(in range: Range<Date>) -> [PromptRecord] {
        loadRecursiveJsonlPrompts(
    ...
    private static func loadRecursiveJsonlPrompts(
        root: String,
        range: Range<Date>,
        extractor: (URL, Range<Date>) -> [PromptRecord]
    ) -> [PromptRecord] {
    ...
    private static func loadProjectsPrompts(in range: Range<Date>,
    ...
    private static func loadDesktopPrompts(in range: Range<Date>) -> [PromptRecord] {
    ...
    public static func loadPrompts(forDay day: Date,
        ...
        return loadPrompts(in: start..<end)
    }
    ...
    public static func loadPrompts(forWeekContaining day: Date,
        ...
        return loadPrompts(in: weekStart..<weekEnd)
    }
