...
final class ReportGeneratorTests: XCTestCase {
    ...
    func testMarkdownContainsAllSectionsAndPrompts() {
        ...
        XCTAssertTrue(md.contains("AGENTWATCH REPORT"))
    ...
    func testHTMLIsWellFormedWithSummaryCards() {
        ...
        XCTAssertTrue(html.contains("<html lang=\"vi\">"))
        XCTAssertTrue(html.contains("vi_VN"))
        XCTAssertTrue(html.contains("Tổng prompts"))
        XCTAssertTrue(html.contains("</html>"))
    }

    func testVietnameseLocaleSeparatesLanguageAndRegionCodes() {
        XCTAssertEqual(AgentWatchLocale.languageCode, "vi")
        XCTAssertEqual(AgentWatchLocale.regionCode, "VN")
        XCTAssertEqual(AgentWatchLocale.identifier, "vi_VN")
        XCTAssertEqual(AgentWatchLocale.htmlLanguageTag, "vi")
        XCTAssertEqual(AgentWatchLocale.timeZoneLabel, "GMT+7")
    }
